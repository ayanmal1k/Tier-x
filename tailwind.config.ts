...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        "display-mega": ["80px", { lineHeight: "1", letterSpacing: "-2px", fontWeight: "700" }],
        "display-xl": ["64px", { lineHeight: "1", letterSpacing: "-1.6px", fontWeight: "700" }],
        "display-lg": ["52px", { lineHeight: "1", letterSpacing: "-1.3px", fontWeight: "700" }],
        "display-md": ["44px", { lineHeight: "1.09", letterSpacing: "-1px", fontWeight: "700" }],
        "display-sm": ["48px", { lineHeight: "1.1", letterSpacing: "-1px", fontWeight: "600" }],
